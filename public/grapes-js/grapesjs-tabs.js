    ...
    return function (t) {
        ...
        t.exports = function (t, e) {
            ...
            if (Object.getOwnPropertySymbols) {
                ...
                for (o = 0; o < c.length; o++) n = c[o], e.indexOf(n) >= 0 || Object.prototype.propertyIsEnumerable.call(t, n) && (a[n] = t[n])
            }
            return a
        }
    }, function (t, e) {
        ...
        var b = function (t, e) {
            var n = e.defaultModel, r = e.typeTabs, a = e.selectorTab, i = (e.editor, c()(e, ["defaultModel", "typeTabs", "selectorTab", "editor"])), b = [{
                full: 1, type: 'button', label: !1, text: 'Style Active', command: function (t) {
            ...
            t.addType(i.typeTab, {
                model: {
                    defaults: s({name: 'Tab', draggable: "[data-gjs-type=\"".concat(i.typeTabContainer, "\"]"), attributes: {role: "tab"}, components: i.templateTab, classes: i.classTab, traits: b}, i.tabProps), init: function () {
                        this.on('removed', this.__onRemove)
                    }, __initTab: function () {
                        if (!this.tabContent) {
                            var t = this.getTabContent();
                            if (!t) {
                                var e, n = (t = this.getTabsType().getContentsType().append({type: i.typeTabContent, components: i.templateTabContent(this)})[0]).getId(), r = this.getId();
                                t.addAttributes({id: n, 'aria-labelledby': r, hidden: !0}), this.addAttributes((e = {}, o()(e, a, n), o()(e, "id", r), e)), this.tabContent = t
                            }
                            this.tabContent = t
                        }
                    }, __onRemove: function () {
                        ...
                        var t = this.getAttributes()[a], e = this.getTabsType();
                        if (e && t) return e.findContents().filter((function (e) {
                            return e.getId() == t
                        }))[0]
                    }, clone: function () {
        ...
        var u = function (t, e) {
            var n = e.typeTab, r = e.typeTabContent, o = e.typeTabContents, a = e.typeTabContainer, i = e.style, s = c()(e, ["typeTab", "typeTabContent", "typeTabContents", "typeTabContainer", "style"]), b = s.typeTabs, p = [1, 2, 3].map((function (t) {
                return {type: n}
            }));
            t.addType(b, {
                model: {
                    defaults: l({
                        name: 'Tabs', classactive: s.classTabActive, selectortab: s.selectorTab, 'script-props': ['classactive', 'selectortab'], script: function (t) {
                            ...
                            full: 1, type: 'button', label: !1, text: 'Add Tab', command: function (t) {
                                var e = t.getSelected();
                                e && e.addTab()
                            }
                        }], components: [{type: a, components: p}, {type: o}, i && "<style>".concat(i(s), "</style>")]
                    }, s.tabsProps), init: function () {
        ...
        var d = function (t, e) {
            t.addType(e.typeTabContent, {model: {defaults: y({name: 'Tab Content', draggable: !1, copyable: !1, removable: !1, highlightable: !1, attributes: {role: "tabpanel"}, classes: e.classTabContent, traits: []}, e.tabContentProps)}})
        };
        ...
        var j = function (t, e) {
            t.addType(e.typeTabContents, {model: {defaults: g({name: 'Tab Contents', draggable: !1, droppable: !1, copyable: !1, removable: !1, classes: e.classTabContents}, e.tabContentsProps)}})
        };
        ...
        var w = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = t.DomComponents, r = P(P({}, e), {}, {defaultModel: n.getType('default').model, editor: t});
        ...
        var S = function (t, e) {
            var n = e.tabsBlock, r = e.typeTabs, a = t.BlockManager;
        ...
        e.default = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = _(_({}, D), e);
            w(t, n), S(t, n)
        }
    }])
}));
