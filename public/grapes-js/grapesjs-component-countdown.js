...
!function (n, t) {
    ...
    const o = function (n, t) {
        void 0 === t && (t = {});
        var o = e({id: 'countdown', label: 'Geri Sayım', block: {}, props: {}, style: '', styleAdditional: '', startTime: '', endText: 'Süre Doldu', dateInputType: 'date', labelDays: 'gün', labelHours: 'saat', labelMinutes: 'dakika', labelSeconds: 'saniye', classPrefix: 'countdown'}, t), a = o.block, c = o.props,
            d = o.style, s = o.id, l = o.label, i = o.classPrefix;
        a && n.Blocks.add(s, e({
        ...
        n.Components.addType(s, {
            model: {
                defaults: e({
                    ...
                    droppable: !1,
                    script: function (n) {
                        var t = n.startfrom, e = n.endText, o = this, a = new Date(t).getTime(), c = o.querySelector('[data-js=countdown]'), d = o.querySelector('[data-js=countdown-endtext]'), s = o.querySelector('[data-js=countdown-day]'), l = o.querySelector('[data-js=countdown-hour]'),
                            i = o.querySelector('[data-js=countdown-minute]'), r = o.querySelector('[data-js=countdown-second]'), u = o.__gjsCountdownInterval;
                        u && clearInterval(u);
                    ...
                    traits: [{label: 'Tarih', name: 'startfrom', changeProp: !0, type: o.dateInputType}, {label: 'Süre Dolunca', name: 'endText', changeProp: !0}],
