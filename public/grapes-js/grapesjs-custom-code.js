...
!function (e, t) {
    ...
    var o = 'custom-code-plugin__code', n = 'custom-code', i = 'custom-code:open-modal', r = void 0 && (void 0).__assign || function () {
    ...
    const d = function (e, t) {
        ...
        !function (e, t) {
            ...
            a.addType('script', {
                ...
                model: {
                    defaults: r({name: 'Custom Code', editable: !0, components: {tagName: 'span', components: {type: 'textnode', content: 'Insert here your custom code'}}}, t.propsCustomCode), init: function () {
                        this.on("change:".concat(o), this.onCustomCodeChange);
                        var e = this.get(o);
                        !this.components().length && this.components(e);
                        var t = this.get('toolbar'), n = 'custom-code';
                        c && !t.filter((function (e) {
                            return e.id === n
                        })).length && t.unshift(r({id: n, command: i, label: "<svg viewBox=\"0 0 24 24\">\n              <path d=\"M14.6 16.6l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4m-5.2 0L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4z\"></path>\n            </svg>"}, c))
                    ...
                    events: {dblclick: 'onActive'}, init: function () {
                        ...
                        s && clearInterval(s), s = setTimeout((function () {
                            var n = e, i = n.model, r = n.el, s = !0;
                            (i.get(o) || '').indexOf('<script') >= 0 && t.placeholderScript && (r.innerHTML = t.placeholderScript, s = !1), i.set({droppable: s})
                        }), 0)
                    }, onActive: function () {
                        var e = this.model;
            ...
            var o = (void 0 === t ? {} : t).blockCustomCode, i = e.Blocks;
            o && i.add(n, s({label: 'Özel Kod', media: "\n      <svg viewBox=\"0 0 24 24\">\n        <path d=\"M14.6 16.6l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4m-5.2 0L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4z\"></path>\n      </svg>\n    ", category: 'Extra', activate: !0, select: !0, content: {type: n}}, o))
        }(e, d), function (e, t) {
            void 0 === t && (t = {});
            var n = t.modalTitle, r = t.codeViewOptions, s = t.commandCustomCode, c = function (e, t) {
                t instanceof HTMLElement ? e.appendChild(t) : t && e.insertAdjacentHTML('beforeend', t)
            };
            e.Commands.add(i, a({
                keyCustomCode: o, run: function (e, t, o) {
                    void 0 === o && (o = {});
                    ...
                    var s = r.title || n, a = t.get(o) || '', c = this.getContent();
                    ...
                    var t = this.getCodeViewer(), o = document.createElement('div'), n = e.getConfig('stylePrefix');
                    ...
                    var o = this, n = document.createElement('button');
                    ...
                    var t = this.target, n = this.getCodeViewer().getContent();
                    t.set(o, n), e.Modal.close()
                }, getCodeViewer: function () {
                    return this.codeViewer || (this.codeViewer = e.CodeManager.createViewer(a({codeName: 'htmlmixed', theme: 'hopscotch', readOnly: 0}, r))), this.codeViewer
                }
            }, s))
        }(e, d)
    };
