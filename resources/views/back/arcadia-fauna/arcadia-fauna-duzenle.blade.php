...
@section('title',"Arcadia Fauna İçerik Düzenle")
@section('content')
                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Arcadia Fauna İçerik Düzenle</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a class="text-muted" href="{{route("admin.arcadia-fauna")}}">Arcadia Fauna</a>
                                        </li>
                                        <li class="breadcrumb-item" aria-current="page">
                                            Arcadia Fauna İçerik Düzenle
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="card w-100">
                            <div class="card-body">
                                <div class="form-group">
                                    <livewire:back.arcadia-fauna.arcadia-fauna-duzenle id="{{$id}}"/>
                                </div>
                            </div>
                        </div>
                    </div>
