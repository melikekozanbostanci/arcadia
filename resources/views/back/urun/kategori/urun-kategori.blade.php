                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Ürün Kategorileri</h4>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-12 col-lg-8">
                                            <a href="{{route("admin.urun-kategorileri-ekle")}}" class="btn btn-primary mb-3">Yeni Ürün Kategorisi Ekle</a>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <form action="{{route("admin.urun-kategorileri")}}" method="get">
                                                <div class="input-group mb-3">
                                                    ...
                                                    @if(request()->get("search"))
                                                        <a href="{{route("admin.urun-kategorileri")}}" class="btn btn-outline-warning">Temizle</a>
                                                    @endif
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm table-striped">
                                            ...
                                            @if($kategori->count() == 0)
                                                <tbody>
                                                <tr>
                                                    <td colspan="6" class="text-center py-5"><b>Henüz Ürün Kategorisi Eklenmemiş</b></td>
                                                </tr>
                                                </tbody>
                                            @else
                                                <tbody>
                                                @foreach($kategori as $urun)
                                                    <tr>
                                                        <td class="align-middle">{{$urun->kategori_adi}}</td>
                                                        ...
                                                        <td class="align-middle">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <a href="{{route("admin.urun-kategorileri-duzenle",$urun->id)}}" class="btn btn-info btn-sm">
                                                                    <i class="fal fa-edit"></i>
                                                                </a>
                                                                <form action="{{route("admin.urun-kategorileri-sil",$urun->id)}}" method="post" id="deleteForm{{$urun->id}}">
                                                                    @csrf
                                                                    @method('DELETE')
