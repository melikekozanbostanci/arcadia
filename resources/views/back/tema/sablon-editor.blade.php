...
<div class="panel__top">
    <div style="display: flex; width: 100%!important;">
        <div style="width:33%; display: flex; justify-content: start!important; align-items: center!important; padding: 0 5px!important;">
            <a href="{{ route("admin.sablonlar") }}" class="btnSave" style="text-decoration: none; background-color: #0a7ea4!important;">Vazgeç</a>
        ...
        <div style="width:33%; display: flex; justify-content: end!important; align-items: center!important; padding: 0 5px!important;">
            <h5 style="color: #fff">Şablon Düzenle - {{$sablon->baslik}}</h5>
        </div>
    </div>
</div>

<div id="gjs">{!! $sablon->sablon !!}</div>
...
<script type="text/javascript">
    ...
    function saveDB() {
        ...
        $.ajax({
            type: "PUT",
            url: "{{route("admin.sablon-guncelle",$sablon->uuid)}}",
            data: data,
    ...
    function saveAndPreview() {
        ...
        $.ajax({
            type: "PUT",
            url: "{{route("admin.sayfa-guncelle",$sablon->uuid)}}",
            data: data,
            success: function (response) {
                toastr.success('Sayfa güncellendi.');
                window.open("{{route("sayfa",$sablon->slug)}}", "_blank");
            }
        });
    }
