        ...
        <div class="row">
            <div class="col-12 col-lg-3">
                ...
                <div wire:ignore>
                    ...
                    @if($temp_fotograf)
                        <input type="file" wire:model="fotograf" class="dropify" data-default-file="{{asset("storage/bloglar/$temp_fotograf")}}"/>
                    @else
            ...
            <div class="col-12 col-lg-9">
                ...
                <a href="{{ route("admin.bloglar") }}" class="btn btn-danger mt-2">Vazgeç</a>
